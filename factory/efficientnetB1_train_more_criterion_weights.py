...
dataset_path = "./storage/images/more_apples/test"
transform = T.Compose(
    [
        T.ToTensor(),
...
# model = torch.hub.load("pytorch/vision", "efficientnet_b1", weights="IMAGENET1K_V1")

from torchvision.models import efficientnet_b1
model = efficientnet_b1(pretrained=True, num_classes=2)
...
wandb.init(project="Efficientnet_B1", config=parameters)
