...
class MyAQLclass:
    def __init__(self, test_input=None, lotsize=500, product_class=1, test_inspection_lvl='I', first_max_percentage=0.4, secund_max_percentage=6.5, third_max_percentage=15):
    ...
    def batch_size(self):
        ...
        batch_size_first = self.table_sample_size(letter_code, self.first_max_percentage)
        batch_size_secund = self.table_sample_size(letter_code, self.secund_max_percentage)
        batch_size_third = self.table_sample_size(letter_code, self.third_max_percentage)
    ...
    def cut_off_per_class(self):
        ...
        reject_value_secund = self.rejectionValue(letter_code, self.secund_max_percentage)
        reject_value_third = self.rejectionValue(letter_code, self.third_max_percentage)
        cut_off_per_class = [reject_value_first, reject_value_secund, reject_value_third]
